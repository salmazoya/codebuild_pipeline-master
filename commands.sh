...
docker tag calendly:latest 781346156393.dkr.ecr.us-east-1.amazonaws.com/calendly:latest

##you can get above URI from AWS ECR console
## Command to connect to AWS ECR
aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 781346156393.dkr.ecr.us-east-1.amazonaws.com
...
docker push 781346156393.dkr.ecr.us-east-1.amazonaws.com/calendly:latest
